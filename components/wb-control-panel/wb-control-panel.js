...
class ControlPanel extends HTMLElement {
    ...
    organizeSemanticStructure(nav, header, main, footer) {
        ...
        if (window.WBEventLog) {
            window.WBEventLog.logInfo('Semantic structure organized', {
    ...
    handleThemeChange(e) {
        ...
        // 🎯 STEP 1: Apply theme to CONTROL PANEL ITSELF first
        this.setAttribute('data-theme', theme);
        console.log(`🎨 Applied theme to control panel: ${theme}`);

        // 🎯 STEP 2: Fire event for the PAGE to listen to
        ...
        // Log the change
        logEvent('info', `Theme changed to: ${theme} - Applied to control panel and event dispatched`);
    ...
    toggleMinimize() {
        ...
        const minimizeBtn = /** @type {HTMLButtonElement | null} */ (this.querySelector('#minimize-btn'));
        if (minimizeBtn) {
    ...
    setupResizeFunctionality(resizeHandle) {
        ...
        if (savedWidth) {
            const width = String(parseInt(savedWidth));
