...
```
components/wb-rag/
├── wb-rag.js           # Main component + RAGSearchEngine class
├── wb-rag.md           # Documentation
├── wb-rag-demo.html    # Standalone demo
└── claude.md           # This file
```
...
- ✅ Custom event system (wb-rag-ready, wb-rag-search, wb-rag-response, wb-rag-error)
- ✅ Configurable attributes (api-key, knowledge-base-url, api-endpoint)
...
✅ **File Naming**: `wb-rag.js`, `wb-rag.md`, `wb-rag-demo.html`  
✅ **Custom Element**: Properly defined with `customElements.define()`  
✅ **Shadow DOM**: Uses `attachShadow({ mode: 'open' })`  
✅ **Observed Attributes**: Implements `observedAttributes` and `attributeChangedCallback`  
✅ **Documentation**: Complete markdown documentation  
✅ **Demo Page**: Standalone demo included  
✅ **Events**: Custom events with proper detail objects  
✅ **No External CSS**: All styles in Shadow DOM  
✅ **JSDoc Comments**: Component documented with examples  
...
- ✅ Claude provides accurate answers
