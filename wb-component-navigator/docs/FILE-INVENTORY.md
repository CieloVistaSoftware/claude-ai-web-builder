...
```
docs/README.md                   (merged, main documentation)
docs/SIMPLE-INSTRUCTIONS.md      (install and setup guide)
docs/FILE-INVENTORY.md           (this file)
```

All other legacy documentation files have been removed for clarity.
