...
import { WebsiteGeneratorInput, WebsiteGeneratorOutput, GeneratedFile } from './types';
...
class MCPWebsiteGenerator {
  ...
  private async generateWebsite(input: WebsiteGeneratorInput): Promise<WebsiteGeneratorOutput> {
  ...
  private validateInput(input: WebsiteGeneratorInput): boolean {
    return !!(
      input.website?.type &&
      input.content?.title &&
      input.output?.format
  ...
  private async createFiles(input: WebsiteGeneratorInput): Promise<GeneratedFile[]> {
  ...
  private generateHTML(input: WebsiteGeneratorInput): string {
...
<body>
  ...
  private generateContentByType(type: string): string {
    switch (type) {
      case 'portfolio':
        return `
  ...
  private generateCSS(input: WebsiteGeneratorInput): string {
...
@media (max-width: 768px) {
  ...
  private generateReactComponent(input: WebsiteGeneratorInput): string {
...
export default App;`;
  ...
  private generatePackageJson(input: WebsiteGeneratorInput): string {
  ...
  private buildStructure(input: WebsiteGeneratorInput) {
    return {
