...
(function() {
    ...
    class WBResize extends HTMLElement {
        constructor() {
            super();
        ...
        onMouseUp() {
            if (this.isDragging) {
                ...
                // Save position
                const rect = this.targetElement.getBoundingClientRect();
                localStorage.setItem(`wb-resize-${this.targetElement.id || 'element'}-x`, rect.left);
                localStorage.setItem(`wb-resize-${this.targetElement.id || 'element'}-y`, rect.top);
            ...
            if (this.isResizing) {
                ...
                // Save dimensions
                const rect = this.targetElement.getBoundingClientRect();
                localStorage.setItem(`wb-resize-${this.targetElement.id || 'element'}-width`, rect.width);
                localStorage.setItem(`wb-resize-${this.targetElement.id || 'element'}-height`, rect.height);
    ...
    if (!customElements.get('wb-resize')) {
        customElements.define('wb-resize', WBResize);
