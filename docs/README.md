...
│
├── 🚀 setup/                       ← START HERE FIRST!
│   └── START-HERE-FIRST-TIME-SETUP.md
│
├── 📖 howto/                       ← Step-by-step guides
│   ├── HowToUpdateCurrentStatus.md
│   ├── HowToCreateWebcomponent.md
│   ├── ClaudeMdChangeDetection.md
│   ├── ClaudeMdFilenamePrefixSystem.md
│   └── ClaudeMdFilenamePrefixQuickRef.md
│
├── 📊 status/                      ← Project status tracking
│   ├── currentstatus.md            ← MASTER STATUS FILE
│   ├── fixes.md                    ← All code changes log
│   ├── READY-TO-PUBLISH.md
│   └── status-issues/              ← Detailed status reports
│
...
│   ├── harmony-modes-analysis.md
│   ├── harmony-modes-complete-guide.md
│   └── ARTICLE-PACKAGE-COMPLETE.md
│
├── 📦 component-guides/            ← Component documentation
│   ├── wb-input.md
│   ├── wb-button.md
│   ├── wb-color-harmony.md
│   └── [Other component docs]
│
├── 🏗️ architecture/                ← Architecture & standards
│   ├── ARCHITECTURE-STANDARDS.md
│   └── [Architecture docs]
│
├── 🔧 build/                       ← Build system
│   └── README.md                   ← Complete build system docs
│
├── 🎨 design/                      ← Design resources
│   └── visual-assets-checklist.md
│
├── 📚 reference/                   ← Reference materials
│   ├── UnifiedInstructions.md
│   └── [API specs, schemas]
│
├── 🔍 troubleshooting/             ← Problem solving
│   └── html-refactor-compliance-report.md
│
├── 📋 configuration/               ← Config files
│   └── ImplementationSuggestions.json
│
├── 📊 reports/                     ← Auto-generated JSON reports
│   ├── README.md
│   ├── claude-status-results.json
│   ├── priority-analysis.json
│   └── unfinished-work-files.json
│
├── 🗄️ archive/                     ← Old/deprecated docs
├── 🧪 prototype/                   ← Prototype docs
├── 📝 claude/                      ← Claude AI specific
├── 🔗 api-specs/                   ← API specifications
├── 🚚 migration/                   ← Migration guides
├── 📌 todo/                        ← TODO lists
└── 📊 events-logging/              ← Event logging docs
```
...
```
1. 📄 setup/START-HERE-FIRST-TIME-SETUP.md
2. 📖 howto/ClaudeMdFilenamePrefixQuickRef.md
3. 📊 status/currentstatus.md
```

### 🔧 Want to Develop?
```
1. 📚 reference/UnifiedInstructions.md
2. 🏗️ architecture/ARCHITECTURE-STANDARDS.md
3. 📖 howto/HowToCreateWebcomponent.md
```

### 📊 Need Current Status?
```
1. 📊 status/currentstatus.md (MASTER STATUS)
2. 📊 status/fixes.md (All changes)
3. 📊 status/status-issues/ (Detailed reports)
```

### 🐛 Having Problems?
```
1. 🔍 troubleshooting/
2. 📊 status/currentstatus.md (Known issues)
3. 📚 reference/UnifiedInstructions.md (Rules)
```
...
**⚠️ IMPORTANT**: `currentstatus.md` is the **SINGLE SOURCE OF TRUTH** for project status
...
**⚠️ IMPORTANT**: `UnifiedInstructions.md` contains ALL project rules and must be followed
...
### The Master Triad
```
1. reference/UnifiedInstructions.md    ← PROJECT RULES (what to do)
2. status/currentstatus.md             ← CURRENT STATUS (what's done/pending)
3. status/fixes.md                     ← CHANGE LOG (what changed)
```
...
**By Topic**:
```
Color system    → articles/, component-guides/wb-color-harmony.md
Status tracking → status/currentstatus.md
How to guides   → howto/
Build issues    → build/, troubleshooting/
Project rules   → reference/UnifiedInstructions.md
```
...
claude.md       → Development logs (in component folders)
```
...
- Component docs: 🟡 In Progress (12% complete)
...
### For Developers
1. ✅ **Always check** `status/currentstatus.md` before starting work
2. ✅ **Always log changes** in `status/fixes.md`
3. ✅ **Always follow rules** in `reference/UnifiedInstructions.md`
4. ✅ **Update documentation** when changing code
5. ✅ **Mark claude.md files** as `UPD-` after editing

### For AI Assistant
1. ✅ **Check for UPD- files** before aggregating
2. ✅ **Update currentstatus.md** after aggregating
3. ✅ **Rename to OK-** after processing
4. ✅ **Follow all rules** in UnifiedInstructions.md
...
✅ **Purpose** (setup, status, system, articles, etc.)  
✅ **Category** (15 clear categories)  
✅ **Importance** (critical files easy to find)  
✅ **Workflow** (clear paths for different needs)
...
2. 🚀 `setup/START-HERE-FIRST-TIME-SETUP.md`
3. 📊 `status/currentstatus.md`
