...
class WBLayoutManager {
    ...
    static loadLayoutCSS() {
        if (typeof WBComponentUtils !== 'undefined') {
            WBComponentUtils.loadCSS('wb-layouts', window.WBComponentUtils?.resolve('styles.layouts') || '/styles/layouts.css');
        } else {
            const link = document.createElement('link');
            link.rel = 'stylesheet';
            link.href = window.WBComponentUtils?.resolve('styles.layouts') || '/styles/layouts.css';
