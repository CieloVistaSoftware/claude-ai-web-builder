...
test_1.test.describe("Theme Control UI Tests", () => {
    (0, test_1.test)("should have single theme control in the floating panel only", async ({ page, }) => {
        ...
        const themeSelectOutsidePanel = await page
            ...
            .count();
        (0, test_1.expect)(themeSelectOutsidePanel).toBe(0);
    });
    (0, test_1.test)("should default to dark mode", async ({ page }) => {
        await page.goto("/wb/wb.html");
        await page.waitForLoadState("networkidle");
        ...
        (0, test_1.expect)(bodyTheme).toBe("dark");
        ...
        (0, test_1.expect)(selectedTheme).toBe("dark");
    });
    (0, test_1.test)("should persist theme selection after page reload", async ({ page }) => {
        ...
        (0, test_1.expect)(bodyTheme).toBe("light");
        // Reset to dark mode for other tests
        await page.selectOption("#theme-select", "dark");
        await page.waitForTimeout(300);
    });
    (0, test_1.test)("should set dark mode as default with no saved state", async ({ page, context, }) => {
...
//# sourceMappingURL=themeControlUI.spec.js.map